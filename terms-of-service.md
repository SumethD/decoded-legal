...
By downloading, installing, or using the Decoded mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the App.

## 2. Service Description

Decoded is a barcode-scanning application that provides ingredient and nutrition transparency information for packaged food and beverage products in Sri Lanka. The App displays ingredient scores, nutrition scores, combined grades, ingredient flags, and product explanations based on publicly available research and product data.

## 3. Health Disclaimer

**Decoded provides ingredient information for educational purposes only. It is not a substitute for medical, dietary, or professional health advice.** Do not rely on Decoded for medical decisions, allergy management, or dietary restrictions. Always consult a qualified healthcare professional for health-related concerns. Decoded does not guarantee the accuracy, completeness, or timeliness of any ingredient or product information.
...
The Decoded App, including its design, scoring algorithms, ingredient database, and content, is owned by Decoded and protected by applicable intellectual property laws. You may not copy, modify, or distribute any part of the App without prior written consent.
...
We may update these Terms from time to time. Continued use of the App after changes constitutes acceptance of the revised Terms. We will notify users of material changes through the App or via email.
